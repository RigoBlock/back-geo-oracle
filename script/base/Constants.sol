...
contract Constants {
    ...
    constructor() {
        ...
        if (chainId == 1) {
            ...
            POOLMANAGER = IPoolManager(address(0x9a13F98Cb987694C9F086b1F5eB990EeA8264Ec3));
        } else if (chainId == 8453) {
            POOLMANAGER = IPoolManager(address(0x498581fF718922c3f8e6A244956aF099B2652b2b));
        } else if (chainId == 42161) {
            POOLMANAGER = IPoolManager(address(0x360E68faCcca8cA495c1B759Fd9EEe466db9FB32));
        } else if (chainId == 137) {
            POOLMANAGER = IPoolManager(address(0x67366782805870060151383F4BbFF9daB53e5cD6));
        } else if (chainId == 81457) {
            POOLMANAGER = IPoolManager(address(0x1631559198A9e474033433b2958daBC135ab6446));
        } else if (chainId == 7777777) {
            POOLMANAGER = IPoolManager(address(0x0575338e4C17006aE181B47900A84404247CA30f));
        } else if (chainId == 480) {
            POOLMANAGER = IPoolManager(address(0xb1860D529182ac3BC1F51Fa2ABd56662b7D13f33));
        } else if (chainId == 57073) {
            POOLMANAGER = IPoolManager(address(0x360E68faCcca8cA495c1B759Fd9EEe466db9FB32));
        } else if (chainId == 1868) {
            POOLMANAGER = IPoolManager(address(0x360E68faCcca8cA495c1B759Fd9EEe466db9FB32));
        } else if (chainId == 43114) {
            POOLMANAGER = IPoolManager(address(0x06380C0e0912312B5150364B9DC4542BA0DbBc85));
        } else if (chainId == 56) {
            POOLMANAGER = IPoolManager(address(0x28e2Ea090877bF75740558f6BFB36A5ffeE9e9dF));
