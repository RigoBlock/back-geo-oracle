...
contract BackGeoOracleScript is Script, DeployPermit2 {
    ...
    function run() public {
        ...
        (address hookAddress, bytes32 salt) =
            HookMiner.find(CREATE2_DEPLOYER, permissions, type(BackGeoOracle).creationCode, abi.encode(address(manager)));

        // ----------------------------- //
        // Deploy the hook using CREATE2 //
        // ----------------------------- //
        vm.broadcast();
        BackGeoOracle oracle = new BackGeoOracle{salt: salt}(manager);
